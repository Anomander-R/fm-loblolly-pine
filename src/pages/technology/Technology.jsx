...
const Technology = () => {
  const [backgroundImage, setBackgroundImage] = useState(
    "/images/bg_technology_desktop.jpg"
  );
  return (
    <>
      <BackgroundHoc backGroundImage={backgroundImage}>
        <section className="home wrapper">
          ...
          <p>
            ...
            ipsam sequi officia sint! Quaerat quis dolore beatae distinctio
            ...
            maiores qui laborum eaque quaerat. 
            </p>
            
            <p>Suscipit cumque nihil veritatis
            ...
            qui repudiandae ut est facilis! 
            </p>
            
            <p>Sequi laboriosam corrupti id quasi
